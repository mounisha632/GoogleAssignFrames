...
Automated end-to-end browser interactions using Selenium WebDriver

Performed mouse hover and right-click actions using the Actions class

Implemented iframe handling and seamless frame switching

Managed multiple browser windows and tab navigation

Simulated keyboard events using Java Robot class

Validated dynamic UI behavior through automated search functionality
